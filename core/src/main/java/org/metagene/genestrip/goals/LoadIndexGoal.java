...
/**
 * Loads the k-mer bloom-filter index ({@link ProbFilter}) from the stored database file, or reuses the
 * already-made in-memory index.
 *
 * @param <P> the project type
 */
public class LoadIndexGoal<P extends GSProject> extends ObjectGoal<ProbFilter, P> implements Goal.LogHeapInfo {
	 ...
	 */
	@SafeVarargs
	public LoadIndexGoal(P project, ObjectGoal<ProbFilter, P> bloomIndex,
