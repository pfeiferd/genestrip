...
public enum GSGoalKey implements GoalKey {
	...
	KMER_RANK_STATS("kmerrankstats"),
	/** Writes a CSV file with the mean, standard deviation and box-plot quartiles of k-mers per rank interval over all species. */
	@MDDescription("Write a CSV file summarizing the `kmerrankstats` result: for the rank intervals `above phylum`, "
			...
			+ "that interval (averaged over all species) together with the standard deviation and the box-plot quartiles "
			+ "(`q1`, `median`, `q3`) over all species.")
	KMER_RANK_STATS_CSV("kmerrankstatscsv"),
