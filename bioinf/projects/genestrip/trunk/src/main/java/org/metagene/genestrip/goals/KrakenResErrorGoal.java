...
public class KrakenResErrorGoal extends FileListGoal<GSProject> {
	private final ObjectGoal<KMerStore<TaxidWithCount>, GSProject> trieFromKrakenResGoal;

	@SafeVarargs
	public KrakenResErrorGoal(GSProject project, String name, File fastq,
			ObjectGoal<KMerStore<TaxidWithCount>, GSProject> trieFromKrakenResGoal, Goal<GSProject>... deps) {
	...
	protected void makeFile(File file) throws IOException {
		...
		KMerStore<TaxidWithCount> trie = trieFromKrakenResGoal.get();
		Map<String, Integer> errPerTaxid = new HashMap<String, Integer>();

		trie.visit(new KMerStoreVisitor<TrieFromKrakenResGoal.TaxidWithCount>() {
			@Override
